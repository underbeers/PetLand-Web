            ...
            {!isMobile ?
                <div className={styles.services}>
                    <div className={styles.card}>
                        ...
                        <Button type={'secondary'} text={'Найти'} className={styles.button}
                                onClick={() => navigate('/services/specialists')} color={'orange'}/>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.title__desc__card}>
                    ...
                    <div className={styles.card}>
                        ...
                        <Button type={'secondary'} onClick={() => navigate('/services/events')} color={'orange'}
                                text={'Посетить'} className={styles.button}/>
                    </div>
                </div>
                :
                <div className={styles.services__mobile}>
                    <div className={styles.item} onClick={() => navigate('/services/specialists')}>
                        ...
                        <div className={styles.text__item}>
                            ...
                            <p className={'secondary__text-2'}>
                                Найдите подходящих ветеринаров,<br/>кинологов, грумеров для ваших питомцев
                            </p>
                        </div>
                    </div>
                    <div className={styles.item} onClick={() => navigate('/services/organizations')}>
                        ...
                        <div className={styles.text__item}>
                            ...
                            <p className={'secondary__text-2'}>
                                Выберите лучшую ветклинику<br/>или гостиницу для животных
                            </p>
                        </div>
                    </div>
                    <div className={styles.item} onClick={() => navigate('/services/events')}>
                        ...
                        <div className={styles.text__item}>
                            <h4>Мероприятия</h4>
                            <p className={'secondary__text-2'}>
                                Посещайте лекции от экспертов,<br/>выставки животных и другие события
                            </p>
                        </div>
                    </div>
                </div>
