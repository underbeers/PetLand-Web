                ...
                <div className={styles.services__mobile}>
                    <div className={styles.item} onClick={() => {
                        ...
                        <div className={styles.text__item}>
                            <h4>Специалисты</h4>
                            <p className={'secondary__text-2'}>Найдите подходящих ветеринаров,<br/>кинологов, грумеров
                                для
                                ваших питомцев</p>
                        </div>
                    </div>
                    <div className={styles.item} onClick={() => {
                        ...
                        <div className={styles.text__item}>
                            ...
                            <p className={'secondary__text-2'}>Выберите лучшую ветклинику<br/>или гостиницу для животных
                            </p>
                        </div>
                    </div>
                    <div className={styles.item} onClick={() => {
                        ...
                        <div className={styles.text__item}>
                            <h4>Мероприятия</h4>
                            <p className={'secondary__text-2'}>Посещайте лекции от экспертов,<br/>выставки животных и
                                другие
                                события</p>
                        </div>
                    </div>
